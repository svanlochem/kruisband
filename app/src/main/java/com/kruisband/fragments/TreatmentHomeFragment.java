...
public class TreatmentHomeFragment extends Fragment {
    View rootView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        webView.loadUrl(getResources().getString(R.string.ref_assets) + getResources().getString(R.string.ref_treatment_home));
