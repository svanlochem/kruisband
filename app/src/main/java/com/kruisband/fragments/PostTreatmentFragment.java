...
public class PostTreatmentFragment extends Fragment {
    ...
    private OnPostTreatmentFragmentInteractionListener mListener;
    ...
    public void onButtonPressed(String text) {
        if (mListener != null) {
            mListener.onPostTreatmentFragmentInteraction(text);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnPostTreatmentFragmentInteractionListener) {
            mListener = (OnPostTreatmentFragmentInteractionListener) context;
        } else {
     ...
     */
    public interface OnPostTreatmentFragmentInteractionListener {
        void onPostTreatmentFragmentInteraction(String text);
    }
}
